...
class Category():
     ...
     def balance(self):
          print(db[self.budget_type])
          return db[self.budget_type]

     def transfer(self, amount, category):
          if category in db.keys():
...
def init():
     print('Welcome to my app, what do you want to do?')
     print('*******************')
     ...
     def operations():
          validator = int(input('Enter 1:Deposit, 2:Withdraw, 3:Balance, 4:Transfer, 5:To Start Again'))
          if validator == 1:
